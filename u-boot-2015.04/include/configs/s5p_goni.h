 ...
 */
#define CONFIG_SERIAL1			1	/* use SERIAL1 */
...
#define CONFIG_EXTRA_ENV_SETTINGS					\
	...
	"meminfo=mem=1024M@0x20000000\0" \
...
#define CONFIG_SYS_PROMPT	"TQ210v4 # "
...
#define PHYS_SDRAM_1		CONFIG_SYS_SDRAM_BASE	/* mDDR DMC0 Bank #0 */
#define PHYS_SDRAM_1_SIZE	(1024 << 20)		/* 1024 MB in Bank #0 */

#if 0
#define PHYS_SDRAM_2		0x40000000		/* mDDR DMC1 Bank #1 */
#define PHYS_SDRAM_2_SIZE	(512 << 20)		/* 256 MB in Bank #1 */
#endif
...
#define CONFIG_ENV_OFFSET		((1000) << 10) /* 400 KiB */
#define CONFIG_ENV_OVERWRITE
